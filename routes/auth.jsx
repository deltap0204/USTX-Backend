...
var AuthController = require('../controllers/auth.tsx');
var paymentController = require('../controllers/stripe.tsx');
var ThirdParty = require('../controllers/thirdparty.tsx');
...
router.post('/GetStates', function (req, res, next) {
    ...
    if (req.body.codecode == "cx") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "cc") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "co") {
        return res.status(200).json({
            statesData: [
                {
                    "region": "Amazonas",
    ...
    if (req.body.codecode == "fk") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "fo") {
        return res.status(200).json({
            statesData: [
                {
    ...
    if (req.body.codecode == "gi") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "gb") {
        return res.status(200).json({
            statesData: [
                {
                    "region": "England",
    ...
    if (req.body.codecode == "mo") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "mk") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "mg") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "mw") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "my") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "mv") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "ml") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "mt") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "mh") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "mq") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "mr") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "mu") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "yt") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "mx") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "md") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "mc") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "mn") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "ms") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "ma") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "mz") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "mm") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "na") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "nr") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "np") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "nl") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "an") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "nc") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "nz") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "ni") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "ne") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "ng") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "nu") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "nf") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "mp") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "no") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "gg") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "om") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "pk") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "pw") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "ps") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "pa") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "pg") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "py") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "pe") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "ph") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "pn") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "pl") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "pt") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "qa") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "re") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "ro") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "ru") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "rw") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "gs") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "sh") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "kn") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "lc") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "pm") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "vc") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "ws") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "sm") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "st") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "sa") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "sn") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "sc") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "sl") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "sg") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "sk") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "si") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "sb") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "so") {
        return res.status(200).json({
            statesData: [
                {
    ...
    if (req.body.codecode == "tw") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "tj") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "tz") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "th") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "tg") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "tk") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "to") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "tt") {
        return res.status(200).json({
            statesData: [
                {
                    "region": "Arima",
    ...
    if (req.body.codecode == "tc") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "tv") {
        return res.status(200).json({
            statesData: [
                {
                    "region": "Funafuti",
    ...
    if (req.body.codecode == "vg") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "vi") {
        return res.status(200).json({
            statesData: [
                {
    ...
    if (req.body.codecode == "eh") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "ye") {
        return res.status(200).json({
            statesData: [
                {
    ...
    if (req.body.codecode == "zr") {
        return res.status(200).json({
            statesData: []
        });
    }
    if (req.body.codecode == "zm") {
        return res.status(200).json({
            statesData: [
                {
                    "region": "Central Province",
...
var storeRedirectToInSession = function (req, res, next) {
